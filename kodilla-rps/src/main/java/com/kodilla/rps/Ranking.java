...
public class Ranking  implements Serializable{
    ...
    public static void printRankingTop10 () {
    ...
    public void saveMap()  {
        ...
        try (ObjectOutputStream o = new ObjectOutputStream((new FileOutputStream("ranking.txt")))) {
    ...
    public void readMap()  {
                ...
                //read from file
        try (ObjectInputStream oi = new ObjectInputStream(new FileInputStream("ranking.txt"))){
