...
public class Ranking implements Serializable {
    ...
    void saveRanking() {
        ...
        try (ObjectOutputStream o = new ObjectOutputStream((new FileOutputStream("kodilla-rps\\src\\main\\resources\\ranking.txt")))) {
    ...
    void readMap() {
        ...
        //read from file
        try (ObjectInputStream oi = new ObjectInputStream(new FileInputStream("kodilla-rps\\src\\main\\resources\\ranking.txt"))) {
